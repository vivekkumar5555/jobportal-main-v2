      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <div className="text-center md:text-left">
            <h2 className="text-xl sm:text-2xl font-bold">Job<span className="text-[#F83002]">Portal</span></h2>
            <p className="text-sm text-gray-600 mt-1">© 2024 JobPortal. All rights reserved.</p>
            <p className="text-xs text-gray-500 mt-1">Connecting talent with opportunity</p>
          </div>
          
          <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-6">
            <div className="flex space-x-4">
              <a href="https://facebook.com" className="hover:text-[#6A38C2] transition-colors" aria-label="Facebook">
              ...
              <a href="https://twitter.com" className="hover:text-[#6A38C2] transition-colors" aria-label="Twitter">
              ...
              <a href="https://linkedin.com" className="hover:text-[#6A38C2] transition-colors" aria-label="LinkedIn">
